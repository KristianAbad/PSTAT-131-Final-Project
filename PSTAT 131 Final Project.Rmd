...
#Currently getting this error "Error in xj[i] : invalid subscript type 'list'"
bag.music <- randomForest(song_popularity ~ . , data = data_4, mtry=ncol(data_4),
                          importance=TRUE,subset=as.vector(music.train) )
bag.music
